...
<div id="sort1 sort">
    ...
    <h4><?php echo $a[1];?>类商品：</h4>

    <?php
    $query2="select * from tb_sc_goods join tb_sc_pic on tb_sc_goods.goods_id=tb_sc_pic.goods_id join tb_sc_gys on tb_sc_gys.goods_id=tb_sc_pic.goods_id join tb_sc_sortinfo on tb_sc_pic.goods_id=tb_sc_sortinfo.goods_id where tb_sc_pic.mr='3' and tb_sc_sortinfo.sname='$a[1]' order by tb_sc_goods.goods_id desc ";
