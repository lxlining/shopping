...
<div id="sort2 sort">
    ...
    <h4><?php echo $a[2];?>类商品：</h4>

    <?php
    $query3="select * from tb_sc_goods join tb_sc_pic on tb_sc_goods.goods_id=tb_sc_pic.goods_id join tb_sc_gys on tb_sc_gys.goods_id=tb_sc_pic.goods_id join tb_sc_sortinfo on tb_sc_pic.goods_id=tb_sc_sortinfo.goods_id where tb_sc_pic.mr='3' and tb_sc_sortinfo.sname='$a[2]' order by tb_sc_goods.goods_id desc ";
    ...
    do {
        ...
        <div style="float: left">
            <tr><td> <a href="sp_info.php?id=<?php echo $info3->goods_id;?>"><img src="admin/upfile2/<?php echo $info3->address;?>" width="120" height="120"></a></td></tr><br/>
            <tr><td>商品名：<?php echo $info3->gname;?></td></tr>
            <br/>
            <tr><td class="sp-r">价格：<?php echo $info3->price;?></td></tr>
        </div>
        <?php
    }while($info3=$result3->fetch(PDO::FETCH_OBJ));
